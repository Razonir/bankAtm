...
public class PullingOther extends JFrame {
	...
	public PullingOther(String ID) {
		...
		panel_5.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				PullingFee pullingfee = new PullingFee(ID,textField.getText());
				pullingfee.show();
				dispose();
			}
		});
		...
		JLabel lblNewLabel_5_1 = new JLabel("Pulling");
